...
from scripts.sabio_rk_support_common import (
    ...
    _read_json,
    build_sabio_rk_support_validation,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Validate the SABIO-RK accession-level support preview."
    )
    parser.add_argument("--sabio-support-preview", type=Path, default=DEFAULT_OUTPUT_JSON)
...
def main() -> None:
    args = parse_args()
    payload = build_sabio_rk_support_validation(
        _read_json(args.sabio_support_preview),
