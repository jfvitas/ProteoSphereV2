...
DEFAULT_OUTPUT_JSON = REPO_ROOT / "artifacts" / "status" / "balance_diagnostics_preview.json"
DEFAULT_OUTPUT_MD = REPO_ROOT / "docs" / "reports" / "balance_diagnostics_preview.md"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export balance diagnostics preview.")
...
def main() -> None:
    args = parse_args()
    payload = build_balance_diagnostics_preview(
    ...
    write_text(args.output_md, render_markdown("Balance Diagnostics Preview", payload))
