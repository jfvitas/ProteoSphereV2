...
from scripts.kinetics_enzyme_support_common import (
    ...
    _read_json,
    build_kinetics_enzyme_support_preview,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Export the kinetics/enzyme accession-level support preview."
    )
...
def main() -> None:
    args = parse_args()
    payload = build_kinetics_enzyme_support_preview(
